...
if __name__ == "__main__":
    ...
    db, data = start_app()
    send_facebook_profile(db, "Facebook Profile Windows test 18", data)
    # send_facebook_profile(db, "Facebook Profile Windows test 19", data, data_2)
    # send_facebook_profile(db, "Facebook Profile Windows test 20", data, data_3)
    # send_facebook_profile(db, "Facebook Profile Windows test 21", data, data_4)
    # send_facebook_profile(db, "Facebook Profile Windows test 22", data, data_4)
    # send_facebook_profile(db, "Facebook Profile Windows test 23", data, data_3)
    # send_facebook_profile(db, "Facebook Profile Windows test 24", data, data_2)
